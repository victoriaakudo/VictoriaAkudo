...
const firstImage = (s?: Section): ImageRef | undefined => {
  for (const b of s?.blocks ?? []) {
    ...
    if (b.kind === "gallery") return b.images[0];
  }
  return undefined;
};
    ...
    <article ref={root}>
      <header
        ...
        style={{
          ...
          backgroundImage:
            "url('/images/projects/loan-app/hero-pattern.png')",
      ...
      <div className="relative z-10  bg-background">
        ...
        {demo && (
          <section className="w-full" style={{ backgroundColor: "#F5F8DE" }}>
            ...
            {demo.caption && (
              <p className="mx-auto mt-6 max-w-[820px] text-center font-sans text-[14px] italic text-[#999999]">
                {demo.caption}
              </p>
            )}
          </section>
        ...
        <section className={GoalSECTION}>
          ...
          {afterImg && (
            <div className={`${IMG} mx-auto max-w-[1500px]`}>
              <Panel image={afterImg} className="mt-14" />
            </div>
          )}
        </section>
